  ...
  return (
    <section className="relative flex min-h-0 w-full flex-1 items-center justify-center overflow-hidden">
      ...
      <div className="relative z-1 flex max-w-full flex-row items-center justify-center gap-6 px-6">
        <p className="max-w-52 shrink-0 text-right font-mono text-base uppercase tracking-[0.18em] text-text-primary">
        ...
        <p className="max-w-52 shrink-0 text-left font-mono text-base uppercase tracking-[0.18em] text-text-primary">
